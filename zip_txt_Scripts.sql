...
@SBOW_ID=11200102,
@UOW_ID=1120010200008,
@Config_Key_Text='DELIMITER',
@Config_Value_Text='29',
@IS_Active_Flag='Y'
...
@SBOW_ID=11200102,
@UOW_ID=1120010200008,
@Config_Key_Text='IS_HEADER_INCLUDED',
@Config_Value_Text='Y',
@IS_Active_Flag='Y'
...
@SBOW_ID=11200102,
@UOW_ID=1120010200008,
@Config_Key_Text='AUDIT_CODE',
@Config_Value_Text='latin-1',
@IS_Active_Flag='Y'
...
@SBOW_ID=11200102,
@UOW_ID=1120010200008,
@Config_Key_Text='IS_FILE_VALIDATION',
@Config_Value_Text='N',
@IS_Active_Flag='Y'
...
@SBOW_ID=11200102,
@UOW_ID=1120010200008,
@Config_Key_Text='IS_SRC_SYS_CD_SEQ',
@Config_Value_Text='N',
@IS_Active_Flag='Y'
...
@SBOW_ID=11200102,
@UOW_ID=1120010200008,
@Config_Key_Text='LZ_TABLE_NAME',
@Config_Value_Text='lz_ams_region_edl_pos',
@IS_Active_Flag='Y'
...
@SBOW_ID=11200102,
@UOW_ID=1120010200008,
@Config_Key_Text='ARCHIVE_FILE_PATH',
@Config_Value_Text='/it/odw/global_abcr_pilot/dataingestion/output/archive/gcw_test/',
@IS_Active_Flag='Y'
...
@UOW_ID=1120010200008,
@Config_Key_Text='IS_COMPRESSED',
@Config_Value_Text='global_abcr_pilot',
@IS_Active_Flag='Y'
...
@SBOW_ID=11200102,
@UOW_ID=1120010200008,
@Config_Key_Text='FILE_HEADER_RECORD',
@Config_Value_Text='{"index":0,"schema": ["designator","subject","seq_num","date_format","ts_format"]}',
@IS_Active_Flag='Y'
...
@SBOW_ID=11200102,
@UOW_ID=1120010200008,
@Config_Key_Text='FILE_FOOTER_RECORD',
@Config_Value_Text='{"index":-1,"schema":footer_schema = ["designator","row_count","total_units","net_sales"]}',
@IS_Active_Flag='Y'
...
@SBOW_ID=11200102,
@UOW_ID=1120010200008,
@Config_Key_Text='BUSINESS_VALIDATION_RULES',
@Config_Value_Text='{"source": {"rule": {"Sales_Qty":"sum","NDP_USD_EXT":"sum"},"type": "data"},"target": {"rule":{"total_units": "value","net_sales": "value"},"type": "footer"},"threshold": "0.1","col_mappings":{"Sales_Qty":"total_units","NDP_USD_EXT":"net_sales"}}',
@IS_Active_Flag='Y'

--Add schema id as parent Id and Add UOWID
